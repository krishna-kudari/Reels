...
const Signin: React.FC<signinProps> = ({}) => {
  ...
  const onSubmit_SignUp = handleSubmit_signup(async (data) => {
    ...
    try {
      createUser(data.signup_email, data.signup_password)
        .then((userCredential) => {
          const user = userCredential.user;
          console.log(user);
          const userId = user.uid;
          const profile_picture_ref = getStorageRef(
          ...
          <div className="flex space-x-1 p-4 px-8 items-center ">
            <div className="relative  h-5 w-5 ">
              <Image
                ...
                alt={"🎬🎞️"}
                className="dark:text-systemTintLight-pink"
              />
            </div>
              ...
              <div className="w-full dark:bg-systembgDark-100 bg-white flex flex-col justify-between ">
                ...
                <div className="h-full  px-12 space-y-10">
                  <div className="space-y-2 ">
                    <p className="font-semibold text-systemLbLight-400 dark:text-systemLbDark-400">
                      LOGIN
                    </p>
                  ...
                  Your Email
                      ...
                      <div className="relative mb-6">
                        ...
                        <input
                          ...
                          placeholder={
                            errors.email ? "email required" : "example@✉️.com"
                          }
                        />
                      </div>
                      {/* <label
                ...
                <div className="flex relative mb-6">
                  ...
                  <div className="">
                    <p className="text-xs font-medium text-systemLbLight-200 dark:text-systemLbDark-200 truncate">
                      ...
                      <br /> <span className="underline">Privacy Policy</span>{" "}
                      and <span className="underline">Terms of Use</span> apply
                    </p>
                  </div>
                </div>
                  ...
                  Username
                      ...
                      <div className="flex relative mb-6">
                        ...
                        <input
                          type="text"
                          id="signup-username"
                          {...register_signup("signup_username", {
                            required: true,
                            maxLength: 32,
                          })}
                  ...
                  Your Email
                      ...
                      <div className="relative mb-6">
                        ...
                        <input
                          ...
                          id="signup-password"
                          autoComplete="off"
                          {...register_signup("signup_password", {
                            required: true,
                            maxLength: 64,
                            minLength: 8,
                          })}
                      ...
                      <div className="flex items-center justify-center w-full mb-6">
                        ...
                        >
                          ...
                          <input
                            {...register_signup("profile_picture", {
                              required: true,
                            })}
                            id="dropzone-file"
                            type="file"
